...
# NOTE: Using Student-t (std) for all models as it's the standard for financial data.
# Student-t captures fat tails better than Normal distribution for returns.
