...
def load_nf_config(config_path="scripts/core/nf_config.json"):
    ...
    Ensures TS-CV pipeline uses same architecture/training as manual (PIPELINE_MODE).
    """
...
# Build TS-CV config from shared NF config; override split-specific settings
TSCV_NF_CONFIG = dict(CONFIG["nf_config"])
TSCV_NF_CONFIG["validation_split"] = 0.0
TSCV_NF_CONFIG["early_stopping"] = False
TSCV_NF_CONFIG["save_models"] = True
TSCV_NF_CONFIG["output_dir"] = "outputs/tscv/nf_models"
TSCV_NF_CONFIG.setdefault("num_layers", 4)
TSCV_NF_CONFIG.setdefault("hidden_features", 64)
TSCV_NF_CONFIG.setdefault("epochs", 75)
TSCV_NF_CONFIG.setdefault("batch_size", 512)
TSCV_NF_CONFIG.setdefault("learning_rate", 0.001)
TSCV_NF_CONFIG.setdefault("clear_cache", True)
