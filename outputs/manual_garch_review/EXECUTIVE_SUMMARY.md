...
5. **Asset-Specific Volatility Bounds Are Ad-Hoc** (Issue #7)
   ...
   - **Status:** ⚠️ METHODOLOGICAL ARTIFACT
...
6. **Stationarity Constraint Differs** (Issue #1)
   ...
   - **Status:** ⚠️ MINOR - Small effect but systematic
...
7. **Initialization Strategy Non-Standard** (Issue #5)
   ...
   - **Status:** ⚠️ MINOR - Asymptotically consistent
...
| ⚠️ ACCEPTABLE | 13/37 | Optimization settings, initialization, external regressors (not needed) |
...
1. ✍️ **Add Methodology Section** documenting all differences:
   ```markdown
...
**Parameter Estimates:** ⚠️ VALID but NOT COMPARABLE (Student-t)
...
**Forecasts:** ⚠️ VALID but DIFFERENT METHODOLOGY
