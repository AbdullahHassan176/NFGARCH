...
## ⚠️ NOTES ON rugarch COMPARISON (Reference Only)
...
⚠️ **Student-t Parameterization:** "Uses standard parameterization where Var(z)=ν/(ν-2)"
⚠️ **TGARCH Specification:** "Implements Zakoian (1994) with conditional standard deviation"
⚠️ **Numerical Stability:** "Asset-specific volatility bounds (15% equity, 3% FX) applied in forecasting"
