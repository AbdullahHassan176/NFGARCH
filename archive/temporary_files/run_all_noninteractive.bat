@echo off
REM Financial-SDG-GARCH - Complete Manual Pipeline (Non-Interactive Version)
REM This version skips the confirmation prompt and runs automatically

echo ========================================
echo FINANCIAL-SDG-GARCH - MANUAL PIPELINE
echo ========================================
echo.
echo Running complete optimized pipeline (45-90 minutes)
echo   Assets: EURUSD, GBPUSD, USDZAR, NVDA, MSFT, AMZN (6 total)
echo   Models: sGARCH, eGARCH, TGARCH, gjrGARCH (4 total)
...
REM =============================================================================
REM STEP 14: GENERATE DISSERTATION TABLES
REM =============================================================================

echo ========================================
echo STEP 14: GENERATING DISSERTATION TABLES
echo ========================================
echo.
echo Extracting and generating dissertation tables...
echo.

"C:\Program Files\R\R-4.5.1\bin\Rscript.exe" scripts\evaluation\extract_dissertation_tables.R
if %errorlevel% neq 0 (
    echo [WARNING] Dissertation tables generation had issues, continuing...
) else (
...
REM =============================================================================
REM STEP 15: GENERATE DISSERTATION FIGURES
REM =============================================================================

echo ========================================
echo STEP 15: GENERATING DISSERTATION FIGURES
echo ========================================
echo.
echo Generating dissertation report figures...
echo.

"C:\Program Files\R\R-4.5.1\bin\Rscript.exe" scripts\evaluation\generate_report_figures.R
if %errorlevel% neq 0 (
...
echo   - results\dissertation_tables\ (CSV tables for dissertation)
echo   - results\figures\ (Dissertation figures)
